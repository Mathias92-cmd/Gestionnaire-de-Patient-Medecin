...
package fr.univ_artois.hopital;
...
/**
 * La classe HopitalApplication illustre le fonctionnement d'une {@link Application} JavaFX.
 *
...
public class HopitalApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fr.univ_artois.hopital/view/hopital-view.fxml"));
        ...
        stage.setTitle("Gestion de l'Hopital");
